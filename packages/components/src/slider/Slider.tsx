...
import './index.less'
import type { CommonEventFunction, EventProps, ITouchEvent } from '@tarojs/components'
import { View } from '@tarojs/components'

// Utils
import { useCustomFieldValue, useRect } from '../vant-use'
import {
  addNumber,
  addUnit,
  clamp,
...
export default defineComponent({
  ...
  setup(props, { emit, slots }) {
    ...
    const onClick: CommonEventFunction<ITouchEvent> = (event) => {
    ...
    const onTouchEnd: EventProps['onTouchEnd'] = (event) => {
      if (props.disabled || props.readonly)
        return
    ...
    return () => (
      <View
        ...
        onTap={onClick}
      >
        <View class={bem('bar')} style={barStyle.value}>
